CUDA_VISIBLE_DEVICES=3 python ../src/pruning.py \
    ...
    --save-dir ../checkpoints/10_1000_ts_wl \
    --pretrained-model ../checkpoints/1/checkpoint_best.pt \
    --restore-file ../checkpoints/10_1000_ts_wl/checkpoint700.pt \
...
CUDA_VISIBLE_DEVICES=3 python ../src/pruning.py \
    ...
    --eval-bleu-print-samples \
    --best-checkpoint-metric bleu --maximize-best-checkpoint-metric \
    --save-dir ../checkpoints/10_1000_ts_wl_2 \
    --pretrained-model ../checkpoints/10_1000_ts_wl/checkpoint_last.pt
