CUDA_VISIBLE_DEVICES=0 python ../src/pruning.py \
    ...
    --save-interval 100 \
    --pruning-iter 1 --pruning-period 2 --decreasing sa \
    --max-tokens 4096 \
    --eval-bleu \
...
CUDA_VISIBLE_DEVICES=0 python ../src/pruning.py \
    ...
    --eval-bleu-print-samples \
    --best-checkpoint-metric bleu --maximize-best-checkpoint-metric \
    --save-dir ../checkpoints/demo2 \
    --pretrained-model ../checkpoints/demo1/checkpoint_last.pt
