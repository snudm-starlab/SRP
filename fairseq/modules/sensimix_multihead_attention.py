...
class SensiMixMultiheadAttention(nn.Module):
    ...
    def __init__(
        ...
        self.k_proj = quant_noise(
            q_Linear(self.kdim, embed_dim, bias=bias), q_noise, qn_block_size
            # nn.Linear(self.kdim, embed_dim, bias=bias), q_noise, qn_block_size
        )
        self.v_proj = quant_noise(
            q_Linear(self.vdim, embed_dim, bias=bias), q_noise, qn_block_size
            # nn.Linear(self.vdim, embed_dim, bias=bias), q_noise, qn_block_size
        )
        self.q_proj = quant_noise(
            q_Linear(embed_dim, embed_dim, bias=bias), q_noise, qn_block_size
    ...
    def forward(
        ...
        if saved_state is not None:
            ...
            key_padding_mask = SensiMixMultiheadAttention._append_prev_key_padding_mask(
